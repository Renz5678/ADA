...
import { useClientNotifications, useClientUnreadCount, useMarkClientAsRead, useMarkAllClientAsRead } from '#hooks/useClientNotifications.js';
...
export default function ClientNotificationDropdown() {
    ...
    const { data: unreadCount } = useClientUnreadCount();
    const markAsReadMut = useMarkClientAsRead();
    const markAllAsReadMut = useMarkAllClientAsRead();

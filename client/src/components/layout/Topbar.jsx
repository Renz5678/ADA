...
import { MdOutlinePersonOutline, MdOutlineCalendarToday } from "react-icons/md";
    ...
    return (
        <div className="flex flex-none w-full bg-[#FFFFFF] border-b-3 border-[#dddddd] h-14 sm:h-16 md:h-[12%] items-center px-3 sm:px-4 gap-3 z-40 relative">
            ...
            <div className="flex items-center gap-3 shrink-0 relative" ref={dropdownRef}>
                ...
                {/* Profile Dropdown */}
                {isProfileOpen && (
                    <div className="absolute right-0 top-12 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">

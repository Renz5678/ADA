        ...
        >
            <div className="w-full max-w-md px-4 flex flex-col gap-4 items-center m-auto">
                ...
                <p className="font-label text-center mt-2">
                    New to ADA?{" "}
                    <Link to="/signup" className="font-semibold text-[#8D4A52] hover:underline">
                        Create an Account
                    </Link>
                </p>
                <p className="font-label text-xs text-gray-500 text-center">
                    Are you a client?{" "}
                    <Link to="/login-client" className="font-semibold text-[#8D4A52] underline hover:text-[#0F1D29]">
                        Login here
                    </Link>
                </p>
            </div>
